...
SensitivityNumber = ti6342_ns.class_("SensitivityNumber", number.Number)
CustomModeNumber = ti6342_ns.class_("CustomModeNumber", number.Number)
ExistenceThresholdNumber = ti6342_ns.class_("ExistenceThresholdNumber", number.Number)
MotionThresholdNumber = ti6342_ns.class_("MotionThresholdNumber", number.Number)
MotionTriggerTimeNumber = ti6342_ns.class_("MotionTriggerTimeNumber", number.Number)
MotionToRestTimeNumber = ti6342_ns.class_("MotionToRestTimeNumber", number.Number)
CustomUnmanTimeNumber = ti6342_ns.class_("CustomUnmanTimeNumber", number.Number)
...
async def to_code(config):
    ...
    if sensitivity_config := config.get(CONF_SENSITIVITY):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_sensitivity_number(n))
    if custom_mode_config := config.get(CONF_CUSTOM_MODE):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_custom_mode_number(n))
    if existence_threshold_config := config.get(CONF_EXISTENCE_THRESHOLD):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_existence_threshold_number(n))
    if motion_threshold_config := config.get(CONF_MOTION_THRESHOLD):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_motion_threshold_number(n))
    if motion_trigger_config := config.get(CONF_MOTION_TRIGGER):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_motion_trigger_number(n))
    if motion_to_rest_config := config.get(CONF_MOTION_TO_REST):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_motion_to_rest_number(n))
    if custom_unman_time_config := config.get(CONF_CUSTOM_UNMAN_TIME):
        ...
        await cg.register_parented(n, ti6342_component)
        cg.add(ti6342_component.set_custom_unman_time_number(n))
