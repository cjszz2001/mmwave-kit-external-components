...
static const char *const TAG = "ti6342";
...
void TI6342Component::handle_frame(void)
{
...
void TI6342Component::handle_ext_msg_enhanced_presence_indication(uint8_t *data, uint32_t length)
{
...
void TI6342Component::handle_ext_msg_target_list(uint8_t *data, uint32_t length)
{
...
void TI6342Component::handle_ext_msg_target_index(uint8_t *data, uint32_t length)
{
...
void TI6342Component::handle_ext_msg_classifier_info(uint8_t *data, uint32_t length)
{
...
void TI6342Component::handle_ext_msg_detected_points(uint8_t *data, uint32_t length)
{

}
void TI6342Component::handle_ext_msg_range_profile_major(uint8_t *data, uint32_t length)
{

}
void TI6342Component::handle_ext_msg_range_profile_minor(uint8_t *data, uint32_t length)
{
...
void TI6342Component::get_radar_output_information_switch() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_product_mode() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_product_id() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_hardware_model() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_firmware_version() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_human_status() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_human_motion_info() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_body_motion_params() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_keep_away() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_scene_mode() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_sensitivity() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_unmanned_time() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_custom_mode() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_existence_boundary() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_motion_boundary() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_spatial_static_value() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_spatial_motion_value() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_distance_of_static_object() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_distance_of_moving_object() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_target_movement_speed() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_existence_threshold() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_motion_threshold() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_motion_trigger_time() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_motion_to_rest_time() {
  uint8_t send_data_len = 10;
...
void TI6342Component::get_custom_unman_time() {
  uint8_t send_data_len = 10;
...
void TI6342Component::set_underlying_open_function(bool enable) {
...
void TI6342Component::set_scene_mode(uint8_t value) {
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_sensitivity(uint8_t value) {
//   if (value == 0x00)
//     return;
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_restart() {
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_unman_time(uint8_t value) {
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_custom_mode(uint8_t mode) {
//   if (mode == 0) {
...
void TI6342Component::set_custom_end_mode() {
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_existence_boundary(uint8_t value) {
...
void TI6342Component::set_motion_boundary(uint8_t value) {
//   if ((this->custom_mode_num_sensor_ != nullptr) && (this->custom_mode_num_sensor_->state == 0))
//     return;  // You'll have to check that you're in custom mode to set it up
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_existence_threshold(int value) {
//   if ((this->custom_mode_num_sensor_ != nullptr) && (this->custom_mode_num_sensor_->state == 0))
//     return;  // You'll have to check that you're in custom mode to set it up
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_motion_threshold(int value) {
//   if ((this->custom_mode_num_sensor_ != nullptr) && (this->custom_mode_num_sensor_->state == 0))
//     return;  // You'll have to check that you're in custom mode to set it up
//   uint8_t send_data_len = 10;
...
void TI6342Component::set_motion_trigger_time(int value) {
//   if ((this->custom_mode_num_sensor_ != nullptr) && (this->custom_mode_num_sensor_->state == 0))
//     return;  // You'll have to check that you're in custom mode to set it up
...
void TI6342Component::set_motion_to_rest_time(int value) {
//   if ((this->custom_mode_num_sensor_ != nullptr) && (this->custom_mode_num_sensor_->state == 0))
//     return;  // You'll have to check that you're in custom mode to set it up
//   int h24_num = (value >> 24) & 0xff;
//   int h16_num = (value >> 16) & 0xff;
...
void TI6342Component::set_custom_unman_time(int value) {
//   if ((this->custom_mode_num_sensor_ != nullptr) && (this->custom_mode_num_sensor_->state == 0))
//     return;  // You'll have to check that you're in custom mode to set it up
//   value *= 1000;
//   int h24_num = (value >> 24) & 0xff;
